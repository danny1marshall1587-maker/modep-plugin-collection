...
#define AELAPSE_URI "http://moddevices.com/plugins/danny/aelapse-mono"
...
enum PortIndex {
    ...
    PORT_DELAY_DRYWET     = 3,
    PORT_DELAY_TIME       = 4,
    PORT_DELAY_FEEDBACK   = 5,
    PORT_DELAY_CUT_LOW    = 6,
    PORT_DELAY_CUT_HI     = 7,
    PORT_DELAY_SATURATION = 8,
    PORT_DELAY_DRIFT      = 9,
    PORT_DELAY_MODE       = 10,

    // Springs
    PORT_SPRINGS_ACTIVE   = 11,
    PORT_SPRINGS_DRYWET   = 12,
    PORT_SPRINGS_WIDTH    = 13,
    PORT_SPRINGS_LENGTH   = 14,
    PORT_SPRINGS_DECAY    = 15,
    PORT_SPRINGS_DAMP     = 16,
    PORT_SPRINGS_SHAPE    = 17,
    PORT_SPRINGS_TONE     = 18,
    PORT_SPRINGS_SCATTER  = 19,
    PORT_SPRINGS_CHAOS    = 20,
...
static void connect_port(LV2_Handle instance, uint32_t port, void* data_location)
{
    ...
    switch (port) {
        case PORT_IN:               self->in               = (const float*)data_location; break;
        case PORT_OUT:              self->out              = (float*)data_location; break;
