function (event, funcs) {
    ...
    pedal.find('#orange-gate-btn').off('click.orange').on('click.orange', function (e) {
        e.stopPropagation();
    ...
    pedal.find('#orange-spectral-btn').off('click.orange').on('click.orange', function (e) {
        e.stopPropagation();
        var isAct = $(this).hasClass('active');
        var nextVal = isAct ? 0.0 : 1.0;
        $(this).toggleClass('active', nextVal > 0.5);
    ...
    pedal.find('#orange-defizz-btn').off('click.orange').on('click.orange', function (e) {
        e.stopPropagation();
        var isAct = $(this).hasClass('active');
        var nextVal = isAct ? 0.0 : 1.0;
        $(this).toggleClass('active', nextVal > 0.5);
