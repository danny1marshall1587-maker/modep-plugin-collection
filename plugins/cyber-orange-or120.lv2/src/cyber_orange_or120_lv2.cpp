...
enum PortIndex {
    ...
    PORT_NOISE_SPECTRAL = 12,
    PORT_NOISE_DEFIZZ   = 13,
    PORT_NOISE_LEVEL    = 14,
    PORT_COUNT          = 14 + 1
};
...
struct CyberOrangeOR120LV2 {
    ...
    CyberOrangeOR120LV2() : dsp(nullptr), audioIn(nullptr), audioOut(nullptr),
        ...
        hfDrive(nullptr), speakerCab(nullptr), speakerDrive(nullptr), noiseGate(nullptr) , outputLevel(nullptr), noiseSpectral(nullptr), noiseDefizz(nullptr) , noiseLevel(nullptr) {}
